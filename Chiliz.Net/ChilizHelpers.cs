...
{
    /// <summary>
    /// Helper methods for the Chiliz API
    /// </summary>
    public static class ChilizHelpers
    {
        /// <summary>
        ...
        public static int? UsedWeight(this IEnumerable<KeyValuePair<string, IEnumerable<string>>>? headers)
        {
            ...
            var headerValues = headers.SingleOrDefault(s => s.Key == "X-BH-USED-WEIGHT").Value;
        ...
        /// <summary>
        /// Validate the string is a valid Chiliz symbol.
        /// </summary>
        /// <param name="symbolString">string to validate</param>
        public static void ValidateChilizSymbol(this string symbolString)
        {
